    ...
    <section id="projects" className="py-20 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="bg-black/90 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl shadow-purple-500/20 overflow-hidden floating-window">
          ...
          <WindowHeaderBar title="Projects.exe" />
          
          <div className="p-8 md:p-10">
            {/* Filter Section - Inside Window */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }}
            ...
            >
              {/* Filter Buttons - Windows Tab Style */}
            ...
            {/* Projects Grid - Windows Folder Style */}
            <motion.div
              layout
        ...
        {/* Project Modal - Windows Window Style */}
        <AnimatePresence>
          {selectedProject && (
            <motion.div
              initial={{ opacity: 0 }}
